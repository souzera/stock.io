            ...
            <div className='flex flex-1'>
                ...
                <main className='flex-1 p-8'>
                    <div className="bg-white rounded-xl h-[100%] shadow-sm p-6">
                        ...
                        <div className=' flex flex-1 h-[85%] bg-green'>
