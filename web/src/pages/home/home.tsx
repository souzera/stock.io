export function Home() {
    return (
        <div className="flex flex-col">
            ...
            <footer className="flex h-32 px-5  bg-black text-zinc-700 justify-between items-center">
                <div className=" flex ">
                ...
                <div className="">
                    <ul className="text-right">
                        <li className="transition duration-1000 ease-in-out hover:text-zinc-700"><a href="#">Políticas de Privacidade</a></li>
                        <li className="transition duration-1000 ease-in-out hover:text-zinc-700"><a href="#">Termos de Uso</a></li>
                        <li className="transition duration-1000 ease-in-out hover:text-zinc-700"><a href="">Fale Conosco</a></li>
                    </ul>
                </div>
            </footer>
        </div>
