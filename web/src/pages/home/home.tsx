    ...
    return (
        <div className="flex flex-col">
            <header className="flex flex-1 mb-3 gap-5 justify-between max-md:justify-center" >
                ...
                <div className="bg-purple-500 w-[20%] mx-8">
                    <img src="../assets/images/SVG/stock_io_logo_name_h.svg" alt="" />
                </div>
